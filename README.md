...
// description: "",
    ...
    const tableHeader = ["Ab", "Cd"];

    const tableData = fee.map((fees) => ({
        id: fees.id,
        program_code: fees.program_code,
        year_level: fees.year_level,
        payment_type: fees.payment_type,
        cash: fees.cash,
        installment: fees.installment,
        voucher_amount: fees.voucher_amount,
        onetime_fee: fees.onetime_fee,
        down_payment_shs: fees.down_payment_shs,
    }));
